...
- Disable about time integration from update token for concurrent crash (About time configuration)
- Add new integration for retrocpmatibility with the old 'LightsHUD'
- Add new option with no ATE integration, just flags
