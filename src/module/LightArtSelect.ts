...
export default class LightArtSelect extends FormApplication {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      id: 'lights-hud-art-select',
      classes: ['sheet'],
      template: 'modules/lights-hud/templates/artSelect.html',
      resizable: true,
      minimizable: false,
    });
  }
  ...
  activateListeners(html) {
    ...
    const boxes = html.find(`.lights-hud-grid-box`);
    boxes.map((box) => {
